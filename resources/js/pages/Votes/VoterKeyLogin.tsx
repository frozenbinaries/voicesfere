...
import { KeyRound, ArrowRight, AlertCircle, Vote, Sun, Moon } from 'lucide-react';
            ...
            <div className="min-h-screen bg-gradient-to-br from-[#FDFDFC] via-white to-red-50 dark:from-[#0a0a0a] dark:via-[#0f0f0f] dark:to-red-950/20">
                ...
                <div className="fixed top-4 right-4 z-50">
                    <button
                        ...
                        className="rounded-lg bg-white/80 p-2 text-gray-600 shadow-lg backdrop-blur-sm transition-all hover:bg-gray-100 dark:bg-[#161615]/80 dark:text-gray-400 dark:hover:bg-gray-800"
